...
Approach::Approach()
{
    ...
    m_sParam.dMaxWheelAngle             = 40.0/180.0*EPI;
    ...
    m_sParam.dWheelAngleAllowedDiff     = 5.0/180.0*EPI;
...
ebool Approach::GetRealisData(edouble &dPaperX, edouble &dPaperY)
{
    ...
    edouble             dTime               = 0;
    CPose               iRobotInRealis,iPaperInRealis,iMarkInRealis,iRobotInMark,iPaperInRobot;
    Matrix4d            iMat;
...
void Approach::TestLidarAndRealis()
{
    edouble             dNow                = 0;
    eint                nCount              = 0;
    CRigidBodyList      iRealisItems;
