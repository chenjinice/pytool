...
typedef struct
{
    ...
    edouble         dPaperValidTime         = 0;        // 纸卷数据有效时间,秒
...
private:
    ...
    ebool               GetRealisData();
    ebool               GetRealisData(edouble &dPaperX,edouble &dPaperY);
    void                WriteLog();
    ...
    edouble             m_dApproachPaperRadius      = 0.6;              // 要靠近的纸卷半径
    edouble             m_dCatchPaperRadius         = 0.6;              // 已经抓取的纸卷半径
