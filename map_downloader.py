...
class MapDownloader(object):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if not cls.instance:
            ...
            cls.map_cfg.append({_kType:[1, 101],_kUrl:'http://mt1.google.com/vt/lyrs=s&x={x}&y={y}&z={z}',_kDir: cls.map_dir+'/map/google_satellite',_kAddr:''})
            cls.map_cfg.append({_kType:[2, 102],_kUrl:'http://mt1.google.com/vt/lyrs=m&x={x}&y={y}&z={z}',_kDir: cls.map_dir+'/map/google_map',_kAddr:''})
            for cfg in cls.map_cfg:
